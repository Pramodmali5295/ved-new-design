  ...
  return (
    <section ref={sectionRef} id="partnership" className="bg-[#1f1912] py-16 sm:py-24 lg:py-36 text-[#ebe4d8]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="gsap-reveal-scale mt-10 sm:mt-12 overflow-hidden rounded-sm border border-[#a8895c]/30 bg-[#140e08] shadow-2xl p-1.5 sm:p-2">
        ...
        {/* Matteo Section */}
        <div className="gsap-reveal mt-10 sm:mt-14 rounded-sm border border-[#a8895c]/40 bg-[#251e16] p-5 sm:p-8 lg:p-10 shadow-2xl">
          {/* Header */}
          ...
          {/* Dedicated Quote Showcase - Luxury Centerpiece Card (Moved Above Media) */}
          <div className="gsap-reveal-scale mt-6 sm:mt-8 relative overflow-hidden rounded-md border border-[#a8895c]/50 bg-gradient-to-br from-[#2a2016] via-[#1c150e] to-[#140e09] p-6 sm:p-8 lg:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              ...
              <div className="flex-1">
                <blockquote className="font-serif text-base sm:text-lg lg:text-xl italic leading-relaxed text-[#f5efe6]">
                  <span className="font-serif text-2xl sm:text-3xl text-[#f0c775] font-bold inline-block mr-1.5 align-top select-none leading-none">&ldquo;</span>
                  I am so grateful to all the horses I have ridden. They have helped me through various competitions, never letting me down. And Matteo is spectacular. We share a bond that’s a bit more special than normal. He is a great jumper. I have found that horses respond to love and technique. Hence, they have taught me trust, humility and patience.
                  <span className="font-serif text-2xl sm:text-3xl text-[#f0c775] font-bold inline-block ml-1.5 align-bottom select-none leading-none">&rdquo;</span>
                </blockquote>
          ...
          {/* Matteo Media Showcase: 3 Photographs + 1 Video Reel (100% Full Uncropped, Balanced Height) */}
          <div className="gsap-stagger-container mt-8 sm:mt-10 grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 items-stretch">
            {/* Photo 1: Matteo in Pasture */}
            <div className="gsap-stagger-item relative overflow-hidden rounded-sm bg-[#120d08] border border-white/10 shadow-xl group flex flex-col justify-between p-3">
              <div 
                onClick={() => setSelectedPhoto({
                  src: '/assets/matto.jpeg',
                  title: 'Fernhill Milchem Mateo (Matteo)',
                  subtitle: 'Pasture & Conditioning · Ocala, Florida',
                })}
                className="relative w-full flex-1 flex items-center justify-center overflow-hidden min-h-[240px] sm:min-h-[260px] max-h-[300px] bg-[#0c0805] rounded-sm cursor-pointer"
              >
                <img
                  src="/assets/matto.jpeg"
                  alt="Fernhill Milchem Mateo in pasture"
                  className="w-full h-auto max-h-[300px] object-contain rounded-sm transition-transform duration-700 group-hover:scale-103"
                  loading="lazy"
                  decoding="async"
                />
            ...
            {/* Photo 2: Matteo Image 1 (matto-1.jpg) */}
            <div className="gsap-stagger-item relative overflow-hidden rounded-sm bg-[#120d08] border border-white/10 shadow-xl group flex flex-col justify-between p-3">
              <div 
                onClick={() => setSelectedPhoto({
                  src: '/assets/matto-1.jpg',
                  title: 'Athletic Form & Balance',
                  subtitle: 'CCI 2★ Irish Sport Horse · Ocala, Florida',
                })}
                className="relative w-full flex-1 flex items-center justify-center overflow-hidden min-h-[240px] sm:min-h-[260px] max-h-[300px] bg-[#0c0805] rounded-sm cursor-pointer"
              >
                <img
                  src="/assets/matto-1.jpg"
                  alt="Matteo athletic form"
                  className="w-full h-auto max-h-[300px] object-contain rounded-sm sm:h-full sm:w-full sm:object-cover sm:object-[center_bottom] sm:scale-[3.2] sm:-translate-y-40 sm:-translate-x-8 transition-transform duration-700 ease-out group-hover:scale-103 sm:group-hover:scale-[3.3]"
                  loading="lazy"
                  decoding="async"
                />
                <div className="absolute top-2.5 left-2.5 rounded-full bg-black/80 px-2.5 py-0.5 font-sans text-[9px] uppercase tracking-widest text-[#e6c994] border border-[#a8895c]/40 backdrop-blur-sm">
              ...
              <div className="w-full bg-[#1c1610] p-3 mt-3 border-t border-white/10 rounded-sm">
                <p className="font-sans text-[10px] sm:text-xs uppercase tracking-wider text-[#e6c994] font-medium">
                  Athletic Form &amp; Balance
                </p>
                <p className="font-sans text-[9px] text-[#d9cdb8]/70">Matteo 1 &middot; Ocala, Florida</p>
              </div>
            </div>

            {/* Photo 3: Matteo Image 2 (matto-2.jpeg) */}
            <div className="gsap-stagger-item relative overflow-hidden rounded-sm bg-[#120d08] border border-white/10 shadow-xl group flex flex-col justify-between p-3">
              <div 
                onClick={() => setSelectedPhoto({
                  src: '/assets/matto-2.jpeg',
                  title: 'Daily Handling & Trust',
                  subtitle: 'Matteo 2 · Ocala, Florida',
                })}
                className="relative w-full flex-1 flex items-center justify-center overflow-hidden min-h-[240px] sm:min-h-[260px] max-h-[300px] bg-[#0c0805] rounded-sm cursor-pointer"
              >
                <img
                  src="/assets/matto-2.jpeg"
                  alt="Matteo daily handling"
                  className="w-full h-auto max-h-[300px] object-contain rounded-sm transition-transform duration-700 group-hover:scale-103"
                  loading="lazy"
                  decoding="async"
                />
              ...
              <div className="w-full bg-[#1c1610] p-3 mt-3 border-t border-white/10 rounded-sm">
                <p className="font-sans text-[10px] sm:text-xs uppercase tracking-wider text-[#e6c994] font-medium">
                  Daily Handling &amp; Trust
                </p>
                <p className="font-sans text-[9px] text-[#d9cdb8]/70">Matteo 2 &middot; Ocala, Florida</p>
              </div>
            </div>

            {/* 1 Video - 100% Full Uncropped, Balanced Height */}
            <div className="gsap-stagger-item relative overflow-hidden rounded-sm bg-[#120d08] border border-white/10 shadow-xl group flex flex-col justify-between p-3">
              <div className="relative w-full flex-1 flex items-center justify-center overflow-hidden min-h-[240px] sm:min-h-[260px] max-h-[300px] bg-[#0c0805] rounded-sm">
                <video
                  ref={videoRef}
              ...
              <div className="w-full bg-[#1c1610] p-3 mt-3 border-t border-white/10 rounded-sm flex items-center justify-between">
                <div>
                  <p className="font-sans text-[10px] sm:text-xs uppercase tracking-wider text-[#e6c994] font-medium">
                    Pasture Turnout &amp; Free Movement
                  </p>
                  <p className="font-sans text-[9px] text-[#d9cdb8]/70">Paddock Freedom &amp; Leisure &middot; Ocala, Florida</p>
                </div>
                <button
                  type="button"
                  onClick={toggleMute}
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-black/70 border border-white/20 text-[#d9cdb8] hover:text-white hover:border-[#e6c994] transition-colors shrink-0 ml-2"
        ...
        >
          ...
          >
            ...
            <div className="w-full mt-3 p-3 bg-[#1c1610] rounded-sm border border-white/10 text-center">
              <h4 className="font-display text-lg sm:text-xl text-[#e6c994]">{selectedPhoto.title}</h4>
              <p className="mt-1 font-sans text-xs text-[#d9cdb8]/80">{selectedPhoto.subtitle}</p>
            </div>
          </div>
        </div>,
        document.body
